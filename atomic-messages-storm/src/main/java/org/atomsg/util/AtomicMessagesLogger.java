...
public class AtomicMessagesLogger implements IAtomicMessagesLogger {
	
	private static AtomicMessagesLogger instance = null;
	...
	private AtomicMessagesLogger() {
		
	}
	
	public static AtomicMessagesLogger getInstance() {
		if (instance == null) {
			instance = new AtomicMessagesLogger();
		}
		return instance;	
	}
